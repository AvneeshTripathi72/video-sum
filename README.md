...
Ensure all variables exist within Vercel's Environment Variables panel before deploying. Because this app is now structured entirely via Next.js App Router, it can be deployed to **Vercel** with zero extra config!
